...
use strict;
open(IN, "resnet50_1.log");
my @str = <IN>;
close(IN);
#print scalar(@str);
#end counting the no.of records

open (TABFILE, 'resnet50_1.log') or die "resnet50_1.log: $!";
my $worksheetno=1;
 
#print "\n$worksheetno\n";
    my $workbook  = Spreadsheet::WriteExcel->new('resnet50_2_comparison.xls');
...
open(IN, "resnet50_2.log");
#print scalar(@str);
#end counting the no.of records
close(IN);
open (TABFILE, 'resnet50_2.log') or die "resnet50_2.log: $!";
