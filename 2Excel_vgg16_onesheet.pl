...
use strict;
open(IN, "vgg_16_1.log");
my @str = <IN>;
close(IN);
#print scalar(@str);
#end counting the no.of records

open (TABFILE, 'vgg_16_1.log') or die "vgg_16_1.log: $!";
my $worksheetno=1;
 
#print "\n$worksheetno\n";
    my $workbook  = Spreadsheet::WriteExcel->new('vgg_16_2_comparison.xls');
...
open(IN, "vgg_16_2.log");
#print scalar(@str);
#end counting the no.of records
close(IN);
open (TABFILE, 'vgg_16_2.log') or die "vgg_16_2.log: $!";
